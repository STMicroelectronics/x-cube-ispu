...
int32_t ism330is_mem_bank_set(stmdev_ctx_t *ctx, ism330is_mem_bank_t val)
{
  ...
  if (ret == 0)
  {
    func_cfg_access.shub_reg_access = (val == ISM330IS_SENSOR_HUB_MEM_BANK) ? 0x1 : 0x0;
    func_cfg_access.ispu_reg_access = (val == ISM330IS_ISPU_MEM_BANK) ? 0x1 : 0x0;
                                   ...
                                   uint16_t mem_addr, uint8_t *mem_data, uint16_t len)
{
  ...
  if (ret == 0)
  {
    ...
    ret = ism330is_write_reg(ctx, ISM330IS_ISPU_MEM_ADDR0, (uint8_t *)&mem_addr_l, 1);
    ret = ism330is_write_reg(ctx, ISM330IS_ISPU_MEM_ADDR1, (uint8_t *)&mem_addr_h, 1);
  }
...
int32_t ism330is_ispu_write_flags(stmdev_ctx_t *ctx, uint16_t data)
{
  ...
  if (ret == 0)
  {
    ...
    ret = ism330is_write_reg(ctx, ISM330IS_ISPU_IF2S_FLAG_H, (uint8_t *)&flag_h, 1);
    flag_l.if2s = (data & 0xff);
    ret = ism330is_write_reg(ctx, ISM330IS_ISPU_IF2S_FLAG_L, (uint8_t *)&flag_l, 1);
  }
...
int32_t ism330is_ispu_int1_ctrl_set(stmdev_ctx_t *ctx, uint32_t val)
{
  ...
  if (ret == 0)
  {
    ...
    ret = ism330is_write_reg(ctx, ISM330IS_ISPU_INT1_CTRL3, (uint8_t *)&int1_ctrl3, 1);

    int1_ctrl2.ispu_int1_ctrl = (val >> 16) & 0xff;
    ret = ism330is_write_reg(ctx, ISM330IS_ISPU_INT1_CTRL2, (uint8_t *)&int1_ctrl2, 1);

    int1_ctrl1.ispu_int1_ctrl = (val >>  8) & 0xff;
    ret = ism330is_write_reg(ctx, ISM330IS_ISPU_INT1_CTRL1, (uint8_t *)&int1_ctrl1, 1);

    int1_ctrl0.ispu_int1_ctrl = val & 0xff;
    ret = ism330is_write_reg(ctx, ISM330IS_ISPU_INT1_CTRL0, (uint8_t *)&int1_ctrl0, 1);
  }
...
int32_t ism330is_ispu_int2_ctrl_set(stmdev_ctx_t *ctx, uint32_t val)
{
  ...
  if (ret == 0)
  {
    ...
    ret = ism330is_write_reg(ctx, ISM330IS_ISPU_INT2_CTRL3, (uint8_t *)&int2_ctrl3, 1);

    int2_ctrl2.ispu_int2_ctrl = (val >> 16) & 0xff;
    ret = ism330is_write_reg(ctx, ISM330IS_ISPU_INT2_CTRL2, (uint8_t *)&int2_ctrl2, 1);

    int2_ctrl1.ispu_int2_ctrl = (val >>  8) & 0xff;
    ret = ism330is_write_reg(ctx, ISM330IS_ISPU_INT2_CTRL1, (uint8_t *)&int2_ctrl1, 1);

    int2_ctrl0.ispu_int2_ctrl = val & 0xff;
    ret = ism330is_write_reg(ctx, ISM330IS_ISPU_INT2_CTRL0, (uint8_t *)&int2_ctrl0, 1);
  }
