...
int32_t lsm6dso16is_mem_bank_set(stmdev_ctx_t *ctx, lsm6dso16is_mem_bank_t val)
{
  ...
  if (ret == 0)
  {
    func_cfg_access.shub_reg_access = (val == LSM6DSO16IS_SENSOR_HUB_MEM_BANK) ? 0x1 : 0x0;
    func_cfg_access.ispu_reg_access = (val == LSM6DSO16IS_ISPU_MEM_BANK) ? 0x1 : 0x0;
...
int32_t lsm6dso16is_mem_bank_get(stmdev_ctx_t *ctx, lsm6dso16is_mem_bank_t *val)
{
  ...
  if (func_cfg_access.shub_reg_access)
  {
    *val = LSM6DSO16IS_SENSOR_HUB_MEM_BANK;
  }
  else if (func_cfg_access.ispu_reg_access)
  {
...
/**
  ...
  *
  */
int32_t lsm6dso16is_data_ready_mode_set(stmdev_ctx_t *ctx, lsm6dso16is_data_ready_mode_t val)
{
  ...
  if (ret == 0)
  {
    drdy_pulsed_reg.drdy_pulsed = ((uint8_t)val & 0x1);
...
/**
  ...
  *
  */
int32_t lsm6dso16is_data_ready_mode_get(stmdev_ctx_t *ctx, lsm6dso16is_data_ready_mode_t *val)
{
  lsm6dso16is_drdy_pulsed_reg_t drdy_pulsed_reg;
  int32_t ret;
...
int32_t lsm6dso16is_xl_hm_mode_set(stmdev_ctx_t *ctx, lsm6dso16is_hm_mode_t val)
{
  ...
  if (ret == 0)
  {
    ctrl6_c.xl_hm_mode = ((uint8_t)val & 0x1);
...
/**
  ...
  *
  */
int32_t lsm6dso16is_xl_full_scale_set(stmdev_ctx_t *ctx, lsm6dso16is_xl_full_scale_t val)
{
  ...
  if (ret == 0)
  {
    ctrl1_xl.fs_xl = ((uint8_t)val & 0x3);
...
/**
  ...
  *
  */
int32_t lsm6dso16is_xl_full_scale_get(stmdev_ctx_t *ctx, lsm6dso16is_xl_full_scale_t *val)
{
  lsm6dso16is_ctrl1_xl_t ctrl1_xl;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_xl_data_rate_set(stmdev_ctx_t *ctx, lsm6dso16is_xl_data_rate_t val)
{
  lsm6dso16is_ctrl1_xl_t ctrl1_xl;
  int32_t ret;
  ...
  if (ret == 0)
  {
    ...
    ctrl1_xl.odr_xl = ((uint8_t)val & 0xf);
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_CTRL1_XL, (uint8_t *)&ctrl1_xl, 1);
  }
...
/**
  ...
  *
  */
int32_t lsm6dso16is_xl_data_rate_get(stmdev_ctx_t *ctx, lsm6dso16is_xl_data_rate_t *val)
{
  lsm6dso16is_ctrl1_xl_t ctrl1_xl;
  lsm6dso16is_ctrl6_c_t ctrl6_c;
  int32_t ret;
...
int32_t lsm6dso16is_gy_hm_mode_set(stmdev_ctx_t *ctx, lsm6dso16is_hm_mode_t val)
{
  ...
  if (ret == 0)
  {
    ctrl7_g.g_hm_mode = ((uint8_t)val & 0x1);
...
/**
  ...
  *
  */
int32_t lsm6dso16is_gy_full_scale_set(stmdev_ctx_t *ctx, lsm6dso16is_gy_full_scale_t val)
{
...
/**
  ...
  *
  */
int32_t lsm6dso16is_gy_full_scale_get(stmdev_ctx_t *ctx, lsm6dso16is_gy_full_scale_t *val)
{
  lsm6dso16is_ctrl2_g_t ctrl2_g;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_gy_data_rate_set(stmdev_ctx_t *ctx, lsm6dso16is_gy_data_rate_t val)
{
  lsm6dso16is_ctrl2_g_t ctrl2_g;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_gy_data_rate_get(stmdev_ctx_t *ctx, lsm6dso16is_gy_data_rate_t *val)
{
  lsm6dso16is_ctrl2_g_t ctrl2_g;
  lsm6dso16is_ctrl7_g_t ctrl7_g;
  int32_t ret;
...
int32_t lsm6dso16is_sleep_set(stmdev_ctx_t *ctx, lsm6dso16is_sleep_t val)
{
  ...
  if (ret == 0)
  {
    ctrl4_c.sleep_g = ((uint8_t)val & 0x1);
...
/**
  ...
  *
  */
int32_t lsm6dso16is_xl_self_test_set(stmdev_ctx_t *ctx, lsm6dso16is_xl_self_test_t val)
{
...
/**
  ...
  *
  */
int32_t lsm6dso16is_xl_self_test_get(stmdev_ctx_t *ctx, lsm6dso16is_xl_self_test_t *val)
{
  lsm6dso16is_ctrl5_c_t ctrl5_c;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_gy_self_test_set(stmdev_ctx_t *ctx, lsm6dso16is_gy_self_test_t val)
{
  lsm6dso16is_ctrl5_c_t ctrl5_c;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_gy_self_test_get(stmdev_ctx_t *ctx, lsm6dso16is_gy_self_test_t *val)
{
  lsm6dso16is_ctrl5_c_t ctrl5_c;
  int32_t ret;
...
int32_t lsm6dso16is_ui_i2c_mode_set(stmdev_ctx_t *ctx, lsm6dso16is_ui_i2c_mode_t val)
{
  ...
  if (ret == 0)
  {
    ctrl4_c.i2c_disable = ((uint8_t)val & 0x1);
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_CTRL4_C, (uint8_t *)&ctrl4_c, 1);
  }
...
/**
  ...
  *
  */
int32_t lsm6dso16is_pin_int1_route_set(stmdev_ctx_t *ctx, lsm6dso16is_pin_int1_route_t val)
{
  ...
  if (ret == 0)
  {
    ...
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_INT1_CTRL, (uint8_t *)&int1_ctrl, 1);
...
/**
  ...
  *
  */
int32_t lsm6dso16is_pin_int1_route_get(stmdev_ctx_t *ctx, lsm6dso16is_pin_int1_route_t *val)
{
  lsm6dso16is_int1_ctrl_t int1_ctrl;
  lsm6dso16is_md1_cfg_t md1_cfg;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_pin_int2_route_set(stmdev_ctx_t *ctx, lsm6dso16is_pin_int2_route_t val)
{
  ...
  if (ret == 0)
  {
    ...
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_INT1_CTRL, (uint8_t *)&int2_ctrl, 1);
...
/**
  ...
  *
  */
int32_t lsm6dso16is_pin_int2_route_get(stmdev_ctx_t *ctx, lsm6dso16is_pin_int2_route_t *val)
{
  lsm6dso16is_int2_ctrl_t int2_ctrl;
  lsm6dso16is_md2_cfg_t md2_cfg;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_int_pin_mode_set(stmdev_ctx_t *ctx, lsm6dso16is_int_pin_mode_t val)
{
  lsm6dso16is_ctrl3_c_t ctrl3_c;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_int_pin_mode_get(stmdev_ctx_t *ctx, lsm6dso16is_int_pin_mode_t *val)
{
  lsm6dso16is_ctrl3_c_t ctrl3_c;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_pin_polarity_set(stmdev_ctx_t *ctx, lsm6dso16is_pin_polarity_t val)
{
  lsm6dso16is_ctrl3_c_t ctrl3_c;
  int32_t ret;
  ...
  if (ret == 0)
  {
    ctrl3_c.h_lactive = ((uint8_t)val & 0x1);
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_CTRL3_C, (uint8_t *)&ctrl3_c, 1);
  }
...
/**
  ...
  *
  */
int32_t lsm6dso16is_pin_polarity_get(stmdev_ctx_t *ctx, lsm6dso16is_pin_polarity_t *val)
{
  lsm6dso16is_ctrl3_c_t ctrl3_c;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_sh_slave_connected_set(stmdev_ctx_t *ctx, lsm6dso16is_sh_slave_connected_t val)
{
  ...
  if (ret == 0)
  {
    master_config.aux_sens_on = (uint8_t)val & 0x3;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_sh_slave_connected_get(stmdev_ctx_t *ctx, lsm6dso16is_sh_slave_connected_t *val)
{
  lsm6dso16is_master_config_t master_config;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_sh_master_interface_pull_up_get(stmdev_ctx_t *ctx, uint8_t *val)
{
  lsm6dso16is_master_config_t master_config;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_sh_syncro_mode_set(stmdev_ctx_t *ctx, lsm6dso16is_sh_syncro_mode_t val)
{
  lsm6dso16is_master_config_t master_config;
  int32_t ret;
  ...
  if (ret == 0)
  {
    master_config.start_config = (uint8_t)val & 0x01;
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_MASTER_CONFIG, (uint8_t *)&master_config, 1);
  }
  if (ret == 0)
  {
...
/**
  ...
  *
  */
int32_t lsm6dso16is_sh_syncro_mode_get(stmdev_ctx_t *ctx, lsm6dso16is_sh_syncro_mode_t *val)
{
  lsm6dso16is_master_config_t master_config;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_sh_write_mode_set(stmdev_ctx_t *ctx, lsm6dso16is_sh_write_mode_t val)
{
  lsm6dso16is_master_config_t master_config;
  int32_t ret;
  ...
  if (ret == 0)
  {
    master_config.write_once = (uint8_t)val & 0x01;
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_MASTER_CONFIG, (uint8_t *)&master_config, 1);
  }
  if (ret == 0)
  {
...
/**
  ...
  *
  */
int32_t lsm6dso16is_sh_write_mode_get(stmdev_ctx_t *ctx, lsm6dso16is_sh_write_mode_t *val)
{
  lsm6dso16is_master_config_t master_config;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_sh_data_rate_set(stmdev_ctx_t *ctx, lsm6dso16is_sh_data_rate_t val)
{
  ...
  if (ret == 0)
  {
    slv0_config.shub_odr = (uint8_t)val & 0x07;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_sh_data_rate_get(stmdev_ctx_t *ctx, lsm6dso16is_sh_data_rate_t *val)
{
  lsm6dso16is_slv0_config_t slv0_config;
  int32_t ret;
...
int32_t lsm6dso16is_ispu_clock_set(stmdev_ctx_t *ctx, lsm6dso16is_ispu_clock_sel_t val)
{
  lsm6dso16is_ctrl10_c_t ctrl10_c;
  int32_t ret;
...
int32_t lsm6dso16is_ispu_clock_get(stmdev_ctx_t *ctx, lsm6dso16is_ispu_clock_sel_t *val)
{
  lsm6dso16is_ctrl10_c_t ctrl10_c;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_ispu_data_rate_set(stmdev_ctx_t *ctx, lsm6dso16is_ispu_data_rate_t val)
{
  ...
  if (ret == 0)
  {
    ctrl9_c.ispu_rate = ((uint8_t)val & 0xf);
...
/**
  ...
  *
  */
int32_t lsm6dso16is_ispu_data_rate_get(stmdev_ctx_t *ctx, lsm6dso16is_ispu_data_rate_t *val)
{
  lsm6dso16is_ctrl9_c_t ctrl9_c;
  int32_t ret;
...
int32_t lsm6dso16is_ispu_bdu_set(stmdev_ctx_t *ctx, lsm6dso16is_ispu_bdu_t val)
{
  ...
  if (ret == 0)
  {
    ctrl9_c.ispu_bdu = ((uint8_t)val & 0x3);
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_CTRL9_C, (uint8_t *)&ctrl9_c, 1);
  }
...
/**
  ...
  *
  */
int32_t lsm6dso16is_ispu_write_dummy_cfg(stmdev_ctx_t *ctx, uint8_t offset, uint8_t *val, uint8_t len)
{
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_ispu_ready_dummy_cfg(stmdev_ctx_t *ctx, uint8_t offset, uint8_t *val, uint8_t len)
{
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_ispu_boot_set(stmdev_ctx_t *ctx, lsm6dso16is_ispu_boot_latched_t val)
{
  ...
  if (ret == 0)
  {
    ispu_config.ispu_rst_n = val;
    ispu_config.clk_dis = val;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_ispu_boot_get(stmdev_ctx_t *ctx, lsm6dso16is_ispu_boot_latched_t *val)
{
  lsm6dso16is_ispu_config_t ispu_config;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_ispu_int_latched_set(stmdev_ctx_t *ctx, lsm6dso16is_ispu_int_latched_t val)
{
  lsm6dso16is_ispu_config_t ispu_config;
  int32_t ret;
  ...
  if (ret == 0)
  {
    ispu_config.latched = ((uint8_t)val & 0x1);
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_CONFIG, (uint8_t *)&ispu_config, 1);
  }
  if (ret == 0)
  {
...
/**
  ...
  *
  */
int32_t lsm6dso16is_ispu_int_latched_get(stmdev_ctx_t *ctx, lsm6dso16is_ispu_int_latched_t *val)
{
  lsm6dso16is_ispu_config_t ispu_config;
  int32_t ret;
...
/**
  ...
  *
  */
int32_t lsm6dso16is_ispu_get_boot_status(stmdev_ctx_t *ctx, lsm6dso16is_ispu_boot_end_t *val)
{
                                      ...
                                      uint16_t mem_addr, uint8_t *mem_data, uint16_t len)
{
  ...
  if (ret == 0)
  {
    ...
    mem_addr_l = mem_addr & 0xFF;
    mem_addr_h = mem_addr / 256;
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_MEM_ADDR0, (uint8_t *)&mem_addr_l, 1);
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_MEM_ADDR1, (uint8_t *)&mem_addr_h, 1);
  }
  ...
  if (ret == 0)
  {
    for (i = 0; i < len; i++)
    {
      ...
      if ((mem_sel == LSM6DSO16IS_ISPU_PROGRAM_RAM_MEMORY) &&
          ((mem_addr + len == 0x2000) || (mem_addr + len == 0x4000) || (mem_addr + len == 0x6000)))
      {
        mem_addr_l = (mem_addr + i) & 0xFF;
        mem_addr_h = (mem_addr + i) / 256;
        ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_MEM_ADDR0, (uint8_t *)&mem_addr_l, 1);
        ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_MEM_ADDR1, (uint8_t *)&mem_addr_h, 1);
      }
...
int32_t lsm6dso16is_ispu_write_flags(stmdev_ctx_t *ctx, uint16_t data)
{
  ...
  {
    /* write the flags */
    flag_h.if2s = (data / 256);
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_IF2S_FLAG_H, (uint8_t *)&flag_h, 1);
    flag_l.if2s = (data & 0xff);
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_IF2S_FLAG_L, (uint8_t *)&flag_l, 1);
  }
...
int32_t lsm6dso16is_ispu_read_data_raw_get(stmdev_ctx_t *ctx,
                                           lsm6dso16is_ispu_dout_read_t *val,
                                           uint8_t len)
{
  int32_t ret;
...
int32_t lsm6dso16is_ispu_int1_ctrl_set(stmdev_ctx_t *ctx, uint32_t val)
{
  ...
  if (ret == 0)
  {
    ...
    int1_ctrl3.ispu_int1_ctrl = (val >> 24) & 0xff;
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_INT1_CTRL3, (uint8_t *)&int1_ctrl3, 1);

    int1_ctrl2.ispu_int1_ctrl = (val >> 16) & 0xff;
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_INT1_CTRL2, (uint8_t *)&int1_ctrl2, 1);

    int1_ctrl1.ispu_int1_ctrl = (val >>  8) & 0xff;
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_INT1_CTRL1, (uint8_t *)&int1_ctrl1, 1);

    int1_ctrl0.ispu_int1_ctrl = val & 0xff;
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_INT1_CTRL0, (uint8_t *)&int1_ctrl0, 1);
  }
...
int32_t lsm6dso16is_ispu_int2_ctrl_set(stmdev_ctx_t *ctx, uint32_t val)
{
  ...
  if (ret == 0)
  {
    ...
    int2_ctrl3.ispu_int2_ctrl = (val >> 24) & 0xff;
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_INT2_CTRL3, (uint8_t *)&int2_ctrl3, 1);

    int2_ctrl2.ispu_int2_ctrl = (val >> 16) & 0xff;
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_INT2_CTRL2, (uint8_t *)&int2_ctrl2, 1);

    int2_ctrl1.ispu_int2_ctrl = (val >>  8) & 0xff;
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_INT2_CTRL1, (uint8_t *)&int2_ctrl1, 1);

    int2_ctrl0.ispu_int2_ctrl = val & 0xff;
    ret = lsm6dso16is_write_reg(ctx, LSM6DSO16IS_ISPU_INT2_CTRL0, (uint8_t *)&int2_ctrl0, 1);
  }
