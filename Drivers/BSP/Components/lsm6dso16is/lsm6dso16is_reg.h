...
typedef enum
{
  ...
  LSM6DSO16IS_GY_ST_NEGATIVE = 0x2,
...
int32_t lsm6dso16is_ispu_read_memory_enable(stmdev_ctx_t *ctx, lsm6dso16is_ispu_memory_type_t val);
